...
static inline V8I _mm256_xor_si256( V8I A,  V8I B){
  int i ;
  V8I R ;
  for(i=0 ; i<8 ; i++) R.v[i] = A.v[i] ^ B.v[i] ;
  return R ;
}
...
static inline V4I _mm_xor_si128( V4I A,  V4I B){
  int i ;
  V4I R ;
  for(i=0 ; i<4 ; i++) R.v[i] = A.v[i] ^ B.v[i] ;
  return R ;
}
...
V8F _mm256_blendv_ps(V8F A, V8F B, V8F MASK){
  int i ;
  V8F R ;
  for(i=0 ; i<8 ; i++) R.v[i] = (MASK.v[i] < 0) ? B.v[i] : A.v[i] ;
  return R ;
}
...
static inline V8I _mm256_cmpeq_epi32(V8I A, V8I B){
  int i ;
  V8I R ;
  for(i=0 ; i<8 ; i++) R.v[i] = (A.v[i] == B.v[i]) ? -1 : 0 ;
  return R ;
}
...
static inline V4I _mm_cmpeq_epi32(V4I A, V4I B){
  int i ;
  V4I R ;
  for(i=0 ; i<4 ; i++) R.v[i] = (A.v[i] == B.v[i]) ? -1 : 0 ;
  return R ;
}
...
static inline V4I _mm256_extracti128_si256(V8I A, int upper){
  ...
  V4I R ;
  for(i=0 ; i<4 ; i++) R.v[i] = A.v[i+offset] ;
  return R ;
}
...
static inline V8I _mm256_max_epi32( V8I A,  V8I B){
  int i ;
  V8I R ;
  for(i=0 ; i<8 ; i++) R.v[i] = (A.v[i] > B.v[i]) ? A.v[i] : B.v[i] ;
  return R ;
}
...
static inline V4I _mm_max_epi32( V4I A,  V4I B){
  int i ;
  V4I R ;
  for(i=0 ; i<4 ; i++) R.v[i] = (A.v[i] > B.v[i]) ? A.v[i] : B.v[i] ;
  return R ;
}
...
static inline V8I _mm256_min_epu32( V8I A,  V8I B){
  int i ;
  V8I R ;
  for(i=0 ; i<8 ; i++) R.v[i] = (A.u[i] < B.u[i]) ? A.u[i] : B.u[i] ;
  return R ;
}
...
static inline V4I _mm_min_epu32( V4I A,  V4I B){
  int i ;
  V4I R ;
  for(i=0 ; i<4 ; i++) R.v[i] = (A.u[i] < B.u[i]) ? A.u[i] : B.u[i] ;
  return R ;
}
...
static inline V8I _mm256_abs_epi32( V8I A){
  int i ;
  V8I R ;
  for(i=0 ; i<8 ; i++) R.v[i] = (A.v[i] < 0) ? -A.v[i] : A.v[i] ;
  return R ;
}
...
static inline V4I _mm_abs_epi32( V4I A){
  int i ;
  V4I R ;
  for(i=0 ; i<4 ; i++) R.v[i] = (A.v[i] < 0) ? -A.v[i] : A.v[i] ;
  return R ;
}
