...
#define __M256   (__m256)
#define __M256i  (__m256i)
#define __M256d  (__m256d)
#define __M128   (__m128)
#define __M128i  (__m128i)
#define __M128d  (__m128d)

#else

// casts (fake casts with simulated SIMD intrinsics)
#define __M256
#define __M256i
#define __M256d
#define __M128
...
SIMD_FN(STATIC, __m256, 8, _mm256_set1_ps(float value) , R.f[i] = value)
SIMD_FN(STATIC, __m128, 4, _mm_set1_ps(float value) ,    R.f[i] = value)

SIMD_FN(STATIC, __m256, 4, _mm256_set1_pd(double value) , R.d[i] = value)
SIMD_FN(STATIC, __m128, 2, _mm_set1_pd(double value) ,    R.d[i] = value)
...
SIMD_FN(STATIC, __m256i, 8, _mm256_blendv_epi32(__m256i A, __m256i B, __m256i MASK), R = __M256i _mm256_blendv_ps(__M256 A, __M256 B, __M256 MASK) )
SIMD_FN(STATIC, __m128i, 4, _mm_blendv_epi32(__m128i A, __m128i B, __m128i MASK),    R = __M128i _mm_blendv_ps(__M128 A, __M128 B, __M128 MASK) )
