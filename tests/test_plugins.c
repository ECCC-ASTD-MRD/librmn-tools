...
int main(int argc, char **argv){
  ...
  name1_0 = (fptr) dlsym(plugin0, "name1") ; fprintf(stderr, "%d\n", (*name1_0)(1) ) ;
  if(name1_0 == NULL) exit(1) ;
  name2_0 = (fptr) dlsym(plugin0, "name2") ; fprintf(stderr, "%d\n", (*name2_0)(2) ) ;
  if(name2_0 == NULL) exit(1) ;
  name3_0 = (fptr) dlsym(plugin0, "name3") ; fprintf(stderr, "%d\n", (*name3_0)(3) ) ;
  if(name3_0 == NULL) exit(1) ;
  name1_1 = (fptr) dlsym(plugin1, "name1") ; fprintf(stderr, "%d\n", (*name1_1)(1) ) ;
  if(name1_1 == NULL) exit(1) ;
  name2_1 = (fptr) dlsym(plugin1, "name2") ; fprintf(stderr, "%d\n", (*name2_1)(2) ) ;
  if(name2_1 == NULL) exit(1) ;
  name3_1 = (fptr) dlsym(plugin1, "name3") ; fprintf(stderr, "%d\n", (*name3_1)(3) ) ;
  if(name3_1 == NULL) exit(1) ;
  name1_2 = (fptr) dlsym(plugin2, "name1") ; fprintf(stderr, "%d\n", (*name1_2)(1) ) ;
  if(name1_2 == NULL) exit(1) ;
  name2_2 = (fptr) dlsym(plugin2, "name2") ; fprintf(stderr, "%d\n", (*name2_2)(2) ) ;
  if(name2_2 == NULL) exit(1) ;
  name3_2 = (fptr) dlsym(plugin2, "name3") ; fprintf(stderr, "%d\n", (*name3_2)(3) ) ;
